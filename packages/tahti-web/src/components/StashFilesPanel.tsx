...
/** File list + upload for the private locker (Stash) — shared between the
 * standalone Stash page and the Music page's Files folder. */
export function StashFilesPanel() {
